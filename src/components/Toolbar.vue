<template>
	...
	<div class="toolbar">
		...
		<label class="userTag" for="">
			...
			<ul class="items">
				...
				<svg v-on:click="activaMenu()" xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="iconMenu bi bi-menu-button-wide" viewBox="0 0 20 20">
	...
	<div v-if="opcionMenu==1" class="menuResponsive">
		...
		<label v-on:click="redirigeHome()" class="homeTag" for="">
		...
		<label v-on:click="redirigeHome()" class="habilidadesTag" for="">
  ...
  <path d="M0 9.665v1.717a1 1 0 0 0 .553.894l6.553 3.277a2 2 0 0 0 1.788 0l6.553-3.277a1 1 0 0 0 .553-.894V9.665c0-.1-.06-.19-.152-.23L9.5 6.715v.993l5.227 2.178a.125.125 0 0 1 .001.23l-5.94 2.546a2 2 0 0 1-1.576 0l-5.94-2.546a.125.125 0 0 1 .001-.23L6.5 7.708l-.013-.988L.152 9.435a.25.25 0 0 0-.152.23z"/>
		...
		<label v-on:click="cierraSesion()" class="cerrarSesionTag" for="">
	...
	export default{
		...
		methods:{
			...
			activaMenu(){
				...
				if (this.opcionMenu=='0') {

					console.log("se muestra menu")
					this.opcionMenu=1;
					$('.menuResponsive').addClass("animacion");
					
				}else{
					console.log("se oculta menu")
					this.opcionMenu=0;
				}
